...
def conv3x3(in_planes, out_planes, stride=1):
    ...
    :return:
    """
    return L.Conv2d(in_planes, out_planes,
...
class TransformerBlock(nn.Module):
    """
    实现了一个Transformer块，其中包含窗口注意力、MLP和可选的位置编码
    """
...
class MODEL(nn.Module):
    """
    定义了整个模型，包括卷积层、基础层和输出层。
    模型的前向传播通过卷积层、基础层和输出层进行，其中基础层包含多个Transformer块
    """
